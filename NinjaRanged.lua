...
-- This is where we will define our aftercast sets.  These are sets of gear that get equiped AFTER the spell or ability is used.  Normally this is used to put you back into your current TP set.
	...
	sets.aftercast.dw0 = {
		...
		right_ring="Haverton Ring +1",
		back={ name="Andartia's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','Rng.Acc.+10','"Snapshot"+10',}},
	}

	sets.aftercast.dw40ken = {
		head={ name="Ryuo Somen +1", augments={'HP+65','"Store TP"+5','"Subtle Blow"+8',}},
		body="Ken. Samue +1",
		hands="Ken. Tekko +1",
		legs="Ken. Hakama +1",
	...
	sets.aftercast.counter = {
		...
		back={ name="Andartia's Mantle", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','Enmity+10','System: 1 ID: 640 Val: 4',}},
	}
end
...
function midcast(spell, act)
	...
	if spell.english == "Empyreal Arrow" then
		equipSetConditionally(sets.midcast.empyreal)
	end
